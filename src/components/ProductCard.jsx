...
const ProductCard = ({item}) => {
  ...
  return (
    // navigate(`/dashboard/products/${title}?detail=${item.id}`,{state:item}) için ProductDetail.jsx dosyasına bak
    // ?detail=${item.id} bu kısmı yapmasan da hatasız çalışır. Bu kısım sadece url^de ürün id'si göstermek için
